...
class TouristObject extends React.Component {
    ...
    render() {
        return (
            <TouchableOpacity style={this.props.style} onPress={() => this.props.navigation.navigate('Hello World', {title:this.props.title, img:this.props.img, desc:this.props.desc})}>
                <Card containerStyle={{width: '80%'}}>
                    <Card.Image source={this.props.img} />
                    <Card.Title style={{color:'#ff4500', textAlign: 'left', alignSelf: 'stretch'}}>{this.props.title}</Card.Title>

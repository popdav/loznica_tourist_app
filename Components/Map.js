...
class MapScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showCarousel: true,
      fullScreen: props.route === undefined ? false : props.route.params.fullScreen
    };
  }
      ...
      <View style={this.state.fullScreen ? styles.fullScreenContainer : styles.container}>
        ...
        <TouchableOpacity
            onPress={async () => {
              ...
              await this.props.navigation.navigate(navigateName, {fullScreen: !this.state.fullScreen});
            }}
        >
          <FontAwesomeIcon size={ 20 } style={{color:'white'}} icon={faExpandArrowsAlt}/>
        </TouchableOpacity>
        ...
        }} onPress={() => {this.setState({showCarousel: !this.state.showCarousel})}}>
          <FontAwesomeIcon size={ 20 } style={{color:'white'}} icon={this.state.showCarousel ? faCompress : faExpand}/>
        </TouchableOpacity>
        ...
        <View style={styles.carousel}>
          <View style={styles.cardContainer}>
            ...
            <CheckBox
              ...
              title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Attraction}/>  Attractions</Text>}
            ...
            <CheckBox
                ...
                title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Hotel}/>  Hotels</Text>}
                iconType='font-awesome'
                size={16}
                containerStyle={styles.checkBoxContainer}
            ...
            <CheckBox
                checked={false}
                // onPress={this.churchesSelected}
                title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Restaurant}/>  Restaurants</Text>}
                iconType='font-awesome'
                size={16}
                containerStyle={styles.checkBoxContainer}
                textStyle={{color: 'white', fontSize: 8}}
            ...
            <CheckBox
                checked={false}
                // onPress={this.churchesSelected}
                title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Feature}/>  Feature</Text>}
                iconType='font-awesome'
                size={16}
                containerStyle={styles.checkBoxContainer}
                textStyle={{color: 'white', fontSize: 8}}
            ...
            <CheckBox
                checked={false}
                // onPress={this.churchesSelected}
                title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Food_Nightlife}/>  Food Nightlife</Text>}
                iconType='font-awesome'
                size={16}
                containerStyle={styles.checkBoxContainer}
                textStyle={{color: 'white', fontSize: 8}}
            ...
            <CheckBox
                checked={false}
                // onPress={this.churchesSelected}
                title={<Text style={{color: 'white', fontSize: 8}}><Image style={{width: 8, height: 10}} source={Pin}/>  Uncategorized</Text>}
                iconType='font-awesome'
                size={16}
                containerStyle={styles.checkBoxContainer}
                textStyle={{color: 'white', fontSize: 8}}
